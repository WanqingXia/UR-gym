...
from UR_gym.envs.tasks.reach import ReachIAI, ReachReg, ReachOri, ReachObs, ReachDyn, ReachSta
...
class UR5StaReachEnv(RobotTaskEnv):
    """Reach task wih UR5 robot. (Added obstacle reward)
