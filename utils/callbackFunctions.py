...
class EvalCallback(EventCallback):
    ...
    def _on_step(self) -> bool:
        ...
        if self.eval_freq > 0 and self.n_calls % self.eval_freq == 0:
            ...
            self.wandb.log({"mean reward": mean_reward, "std reward": std_reward, "mean episode length": mean_ep_length,
                            "std episode length": std_ep_length, "success rate%": success_rate * 100})
