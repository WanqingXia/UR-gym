...
def run_dyn(points):
    """
    In this function, we test the robot's performance in the dynamic environment with the trained model in
    ...
    with open(model_path + 'dyn_test.txt', "w") as f:
...
if __name__ == "__main__":
    # run_sta(np.loadtxt('testset_sta.txt'))
    run_dyn(np.loadtxt('testset_dyn.txt'))
